...
# -*- coding: utf-8 -*-
"""
Created on Mon May 14 10:11:20 2020
...
def doDTC(XY,X,Y,class_label_list,num_folds):
    ...
    for train,test in k_fold.split(XY):
        ...
        predicted_classes = neigh.predict(X1_test)
        ...
        if den!=0:
            specify = num/den
        specificity += specify
        print("Actual Specificity: ",specificity)
        print()
        #Now sensitivity
        num = confusion[1][1]
        ...
        fmeasure += fmeasur
        print("Ovrall F-measure: ",fmeasure)
        print()
    ...
    print("Prediction: ",count_of_a," ",count_of_b)
    print("Actual Class label: ",actual_count_of_a," ",actual_count_of_b)
...
def drawROC(XY,X,Y,class_label_list):
    ...
    # classification
   # classify
    neigh=svm.SVC(probability=True)
